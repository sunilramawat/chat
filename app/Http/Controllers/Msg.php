...
final class Msg{
	...
	function responseMsg($msgId){
	  ...
	  $msg[203] = 'Your account created successfully. Please login in your account.';
	  ...
	  $msg[302] = 'Your request is already sended.';
	  ...
	  $msg[401] = 'Incorrect unique Id and passkey.';
	  ...
	  $msg[433] = 'Request already sended.';
	  ...
	  $msg[499] = 'User is already registered with us.';
